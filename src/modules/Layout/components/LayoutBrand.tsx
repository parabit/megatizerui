...
const LayoutBrand = () => (
	<Stack>
		...
		<Span className="text-2xl md:text-4xl font-bold mt-6">UI Component Library for React</Span>
		<Span className="text-2xl md:text-4xl font-bold mt-1">
			Based on TypeScript + Tailwind CSS
		</Span>
		<Span variant="muted" className="text-xl font-medium mt-6">
